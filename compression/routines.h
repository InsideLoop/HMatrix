...
template <il::int_t p>
il::int_t find_largest_singular_value(const il::Array2D<double> &row,
                                      il::Range range1,
...
//  double largest_singular_value = 0.0;
//
//  il::Array2D<double> row =
//      il::residual_full(M, A, B, range0, range1, i0_search, rank);
//
//  for (il::int_t i1 = range1.begin; i1 < range1.end; ++i1) {
//    bool already_searched = false;
//    for (il::int_t k = 0; k < i1_used.size(); ++k) {
